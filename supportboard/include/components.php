...
<form class="sb sb-rich-login sb-admin-box">
    ...
    <div class="sb-top-bar">
        ...
        <div class="sb-text"><?php echo sb_sanatize_string(sb_get_setting('login-message', defined('SB_WP') ? sb_('Please insert email and password of your WordPress account') : sb_('Enter your login details below'))) ?></div>
    </div>
    <div class="sb-main">
...
<div class="sb-lightbox sb-direct-message-box">
    ...
    <div class="sb-main sb-scroll-area">
        ...
        <div class="sb-bottom">
            ...
            <div></div>
            <a class="sb-btn-text" target="_blank" href="https://board.support/docs#direct-message"><i class="sb-icon-help"></i></a>
        </div>
    </div>
</div>
<?php } ?>
...
function sb_component_admin() {
    ...
    <div class="sb-header">
        <div class="sb-admin-nav">
            ...
            <div>
            <a id="sb-conversations" class="sb-active"><span><?php sb_e('Conversations') ?></span></a>
            <?php
    ...
    <main>
        <div class="sb-active sb-area-conversations">
            ...
            <div class="sb-admin-list">
                <div class="sb-top">
                    <div class="sb-select">
                        <p data-value="0"><?php sb_e('Inbox') ?><span></span></p>
                        <ul>
            ...
            <div>
                ...
                <div class="sb-menu-mobile">
                    ...
                    <ul>
                        ...
                        ?> 
                        <li>
                            <a data-value="message" class="sb-btn-icon" data-sb-tooltip="<?php sb_e('Send a message') ?>"><i class="sb-icon-chat"></i></a>
                        </li>
                        <li>
                            <a data-value="custom_email" class="sb-btn-icon" data-sb-tooltip="<?php sb_e('Send a email') ?>"><i class="sb-icon-envelope"></i></a>      
                        </li>
                        <?php
                        if ($sms) {
        ...
        <div class="sb-area-reports sb-loading">
            ...
            <div>
                ...
                <div class="sb-report-export sb-btn-icon"><i class="sb-icon-download"></i></div>
            </div>
            </div>
            <div class="sb-tab">
            <div class="sb-nav sb-nav-only">
