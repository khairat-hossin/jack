...
*
*/
define('APP_BASE_URL', 'https://crm.globalpresence.support/sandbox/');
...
*/
define('APP_ENC_KEY', '73ce604d8d477f9631e383f9bf4d0e6e');
 ...
 */
define('APP_DB_USERNAME', 'gps7777_sandbox_crm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', 'h+^2lE0R8ZDZ');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'gps7777_crm_sandbox');
