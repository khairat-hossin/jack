...
<a href="<?php echo admin_url('subscriptions_gpm/create?customer_id=' . $client->userid); ?>"
    class="btn btn-primary mbot15<?php echo $client->active == 0 ? ' disabled' : ''; ?>">
    <i class="fa-regular fa-plus tw-mr-1"></i>
    <?php echo _l('new_subscription'); ?>
</a>
<?php } ?>
<?php $this->load->view('admin/subscriptions_gpm/table_html', ['url' => admin_url('subscriptions_gpm/table?client_id=' . $client->userid)]); ?>
<?php } ?>