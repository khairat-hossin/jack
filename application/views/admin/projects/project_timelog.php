               ...
               <div class="panel-body">
                  ...
                  <table class="table table-timesheets-report">
                     <thead>
                        <tr>
                           <?php if(isset($view_all)){ ?>
                           <th width="13%"><?php echo _l('staff_member'); ?></th>
                           <?php } ?>
                           <th width="20%"><?php echo _l('project_timesheet_task'); ?></th>
                           ...
                           <?php } ?>
                           <th width="29%"><?php echo _l('note'); ?></th>
                           <th width="15%"><?php echo _l('task_relation'); ?></th>
                           <th width="10%"><?php echo _l('time_h'); ?></th>
                           <th width="13%"><?php echo _l('time_decimal'); ?></th>
                        </tr>
                     </thead>
                     <tbody></tbody>
                     <tfoot>
                        <tr>
                           ...
                           <td width="29%"></td>
                           <td width="15%"></td>
                           <td width="10%" class="total_logged_time_timesheets_staff_h"></td>
                           <td width="13%" class="total_logged_time_timesheets_staff_d"></td>
                        </tr>
                     </tfoot>
                  </table>
               </div>
