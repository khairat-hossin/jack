            ...
            if (!empty($subscription->stripe_subscription_id) && $subscription->status != 'canceled' && $subscription->status != 'incomplete_expired' && empty($subscription->ends_at)) { ?>
                        ...
                        <div class="btn-group">
                            ...
                            <ul class="dropdown-menu dropdown-menu-right">
                                <li><a
                                        href="<?php echo admin_url('subscriptions_gpw/cancel/' . $subscription->id . '?type=immediately'); ?>">
                                        <?php echo _l('cancel_immediately'); ?></a></li>
                                <li><a
                                        href="<?php echo admin_url('subscriptions_gpw/cancel/' . $subscription->id . '?type=at_period_end'); ?>">
                        ...
                        <?php $this->load->view('admin/subscriptions_gpm/form'); ?>
                    </div>
                </div>
            </div>
            <?php if (isset($subscription)) { ?>
...
<?php if (isset($subscription)) { ?>
<?php $this->load->view('admin/subscriptions_gpm/send_to_client'); ?>
<?php } ?>
<?php init_tail(); ?>
<script>
$(function() {
