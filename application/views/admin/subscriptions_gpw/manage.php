        ...
        <div class="row">
            <div class="col-md-12">
                <div class="_buttons">
                    ...
                    <a href="<?php echo admin_url('subscriptions_gpw/create'); ?>"
                        class="btn btn-primary pull-left display-block">
                        <i class="fa-regular fa-plus tw-mr-1"></i>
                        <?php echo _l('new_subscription')." for GPW"; ?>
                    </a>
                    <?php } ?>
        ...
        ?>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="panel-table-full">
                            ...
                            <?php $this->load->view('admin/subscriptions_gpm/table_html', ['url' => admin_url('subscriptions_gpw/table')]); ?>
                        </div>
                    </div>
                </div>
            </div>
