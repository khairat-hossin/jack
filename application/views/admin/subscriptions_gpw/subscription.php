...
<div id="wrapper">
        ...
        <div class="row">
            <div class="col-md-5">
                <h4 class="tw-mt-0 tw-font-semibold tw-text-lg tw-text-neutral-700">
                    <span>
                        <?php echo isset($subscription) ? $subscription->name : _l('new_subscription').' - GPW'; ?>
                    </span>
                </h4>
                <div class="panel_s">
    ...
    if (!empty($subscription->stripe_subscription_id)
        ...
        ?>
                        ...
                        <a href="<?php echo site_url('subscription_gpw/' . $subscription->hash); ?>" class="btn btn-default"
                            target="_blank">
            ...
            if (!empty($subscription->stripe_subscription_id) && $subscription->status != 'canceled' && $subscription->status != 'incomplete_expired' && empty($subscription->ends_at)) { ?>
                        ...
                        <?php $this->load->view('admin/subscriptions_gpw/form'); ?>
                    </div>
                </div>
            </div>
            <?php if (isset($subscription)) { ?>
...
<?php if (isset($subscription)) { ?>
<?php $this->load->view('admin/subscriptions_gpw/send_to_client'); ?>
<?php } ?>
<?php init_tail(); ?>
<script>
$(function() {
