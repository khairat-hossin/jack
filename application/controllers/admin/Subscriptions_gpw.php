...
class Subscriptions_gpw extends AdminController
{
    ...
    public function index()
    {
        ...
        $this->load->view('admin/subscriptions_gpw/manage', $data);
    }
    ...
    public function table()
    {
        ...
        $this->app->get_table_data('subscriptions_gpw');
    }
    ...
    public function create()
    {
        ...
        if ($this->input->post()) {
            ...
            redirect(admin_url('subscriptions_gpw/edit/' . $insert_id));
        }
        ...
        $this->load->view('admin/subscriptions_gpw/subscription', $data);
    }
    ...
    public function edit($id)
    {
        ...
        if ($this->input->post()) {
            ...
            try {
                ...
                redirect(admin_url('subscriptions_gpw/edit/' . $id));
            }
    ...
    public function delete($id)
    {
        ...
        if (strpos($_SERVER['HTTP_REFERER'], 'clients/') !== false) {
            ...
            redirect(admin_url('subscriptions_gpw'));
        }
    }
}