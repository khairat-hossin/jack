		...
		<div class="modal-body">
			...
			?>
				<div class="row">
					...
					<div class="col-sm-12">
						<?php echo render_textarea('message','','',array('rows'=>6,'placeholder'=>_l('Message'),'data-task-ae-editor'=>true, !is_mobile() ? 'onclick' : 'onfocus'=>('init_editor(\'.tinymce\', {height:200, auto_focus: true});')),array(),'','tinymce'); ?>
					</div>
					<div class="col-sm-12">
