...
foreach ($rResult as $aRow) {
    $row = [];
    $is_favourite = '<span><a href="javascript:void(0);" data-id="'.$aRow['id'].'" data-action="star" data-table=".table-lm-mailbox" onclick="lm_mb_single_inbox(this); return false;"><i class="fa fa-star-o" aria-hidden="true"></i></a></span>';
    $is_bookmark = '<span><a href="javascript:void(0);" data-id="'.$aRow['id'].'" data-action="bookmark" data-table=".table-lm-mailbox" onclick="lm_mb_single_inbox(this); return false;"><i class="fa fa-bookmark-o" aria-hidden="true"></i></a></span>';
