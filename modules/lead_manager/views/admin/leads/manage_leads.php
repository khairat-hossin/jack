      ...
      <div class="row">
            ...
            <div class="_filters _hidden_inputs hidden">
               ...
               foreach($statuses as $status){
                  ...
                  if($status['isdefault'] == 1) {
                     $selected[] = $status['id'];
                     $active = 'active';
                     echo form_hidden('status_'.$status['id'], $status['id']);
                   }else{
                  ...
                  <div class="row mtop0">
                     ...
                     <div class="col-lg-2"><div class="btn-group pull-right btn-with-tooltip-group _filter_data" data-toggle="tooltip" data-title="Filter by">
                        ...
                        <ul class="dropdown-menu dropdown-menu-left" style="width:300px;">
                           ...
                           <li class="divider"></li>
                           <li class="dropdown-submenu pull-left status active">
                              ...
                              <ul class="dropdown-menu dropdown-menu-left">
                                 ...
                                 <?php } ?>
                                 <input type="hidden" name="status_default" id="status_default" value="<?php echo implode(',', $selected); ?>" />
                              </ul>
                           </li>
       ...
       <div class="tab-content">
         <div class="row" id="lead_manager-table">
          ...
          $_table_data[] = array(
            'name'=>_l('Description'),
            'th_attrs'=>array('class'=>'description toggleable','id'=>'th-description')
          );
...
<script type="text/javascript">
    $(function() {
      var status_default = $('#status_default').val();
      console.log("status_default: ", status_default);
      var status_array = status_default.split(","); // explode the comma-separated list into an array

      status_array.forEach(function(status) {
         // dt_custom_view('<?php //echo $status['id']; ?>','.table-lead-managerd','status_<?php //echo $status['id']; ?>')
        //  dt_custom_view(status, '.table-lead-managerd', 'status_'+status); // call the dt_custom_view function for each status
      });
   });
