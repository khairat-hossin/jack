...
public function add_attachment_to_database($rel_id, $rel_type, $attachment, $external = false)
{
   ...
   public function get_staff_in_deparment($department_id)
   {
	...
	/**
	 * get staff active and inactive
	 * @return array 
	 */
	public function get_staff_active_inactive()
	{
		$staff = $this->db->query('select * from '.db_prefix().'staff as s where s.active = "1" OR s.active != "1"  order by s.staffid')->result_array();
		return $staff;
	}
