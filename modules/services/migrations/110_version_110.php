...
class Migration_Version_110 extends App_module_migration
{
    public function up()
    {
        ...
        create_email_template('Your subscription will be renewed soon !',
            '<span> Hello {contact_firstname} ,&nbsp;</span><br /><br />Your Subscription will be expiring soon. Details below.<br /><br />view link : {subscription_link}<br /><br /><br />Kind Regards<br /><br /><span>{email_signature}</span>',
            'subscriptions', 'subscription renewal notification (Sent to customer)', 'subscription-products-to-customer');
