  ...
  (function(){
    ...
    initDataTable(table_registration_leave, admin_url+'timesheets/table_registration_leave', [1], [1], requisitionServerParams, [1, 'desc']);
     ...
     var addtimesheetServerParams = {
      ...
      "staff_filter_ats": "[name='staff_filter_ats[]']",
      "date_f_ats": "[name='date_f_ats']",
      "date_t_ats": "[name='date_t_ats']",
    };
    ...
    $.each(addtimesheetServerParams, function() {
      ...
      $('#staff_filter_ats').on('change', function() {
        table_additional_timesheets.DataTable().ajax.reload()
        .columns.adjust()
        .responsive.recalc();
      });
      
      $('#date_f_ats').on('change', function() {
        table_additional_timesheets.DataTable().ajax.reload()
        .columns.adjust()
        .responsive.recalc();
      });
      
      $('#date_t_ats').on('change', function() {
        table_additional_timesheets.DataTable().ajax.reload()
        .columns.adjust()
        .responsive.recalc();
      });
