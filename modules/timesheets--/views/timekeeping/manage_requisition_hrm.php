         ...
         <div class="col-md-3">
          ...
          <div class="col-md-3 mtop20">
            <div class="select-placeholder">
               <select name="staff_filter[]" class="selectpicker" data-width="100%" id="staff_filter" multiple data-live-search="true" data-none-selected-text="<?php echo _l('Filter by name'); ?>">
                  <?php foreach($staffs as $staff1){ ?>
                  <option value="<?php echo html_entity_decode($staff1['staffid']); ?>"><?php echo html_entity_decode($staff1['firstname']." ".$staff1['lastname']); ?></option>
                  <?php } ?>
               </select>
            </div>
         </div>
         <div class="col-md-3 mtop20">
             <?php echo render_date_input('date_f','','',['placeholder' => _l('Filter by start date')]); ?>
         </div>
         <div class="col-md-3 mtop20">
             <?php echo render_date_input('date_t','','',['placeholder' => _l('Filter by end date')]); ?>
         </div>
     </div>
...
<div class="col-md-3 mtop20">
    <div class="select-placeholder">
       <select name="staff_filter_ats[]" class="selectpicker" data-width="100%" id="staff_filter_ats" multiple data-live-search="true" data-none-selected-text="<?php echo _l('Filter by name'); ?>">
          <?php foreach($staffs as $staff1){ ?>
          <option value="<?php echo html_entity_decode($staff1['staffid']); ?>"><?php echo html_entity_decode($staff1['firstname']." ".$staff1['lastname']); ?></option>
          <?php } ?>
       </select>
 ...
 <div class="col-md-3 mtop20">
     <?php echo render_date_input('date_f_ats','','',['placeholder' => _l('Filter by additional start day')]); ?>
 </div>
 <div class="col-md-3 mtop20">
     <?php echo render_date_input('date_t_ats','','',['placeholder' => _l('Filter by additional end day')]); ?>
 </div>
</div>
<div class="clearfix"></div>
<br>
