 ...
 */
	...
	//	echo '<pre>'; print_r($departments); echo '<br/>';
		$dep_array = array();
		if ($departments) {
		    $department_id = $departments[0];
		    foreach($departments as $key => $value) {
		        $dep_array[] = $value;
		      //  $add_query .= 'or find_in_set(' . $value . ',department)';
		    }
		}
		
		if(in_array(5, $dep_array)){
		    //$add_query .= 'and find_in_set(5,department)';
		    $department_id = 5;
		} else if(in_array(7, $dep_array)){
		    //$add_query .= 'and find_in_set(7,department)';
		    $department_id = 7;
		} else if(in_array(9, $dep_array)){
		    //$add_query .= 'and find_in_set(9,department)';
		    $department_id = 9;
		}
		
	//	echo $department_id; echo '<br/>';
		...
		if ($department_id != '') {
			$add_query .= 'and find_in_set(' . $department_id . ',department)';
		}
...
//		echo '<br/>';
		if (!$data) {
			...
			//	echo "1"; print_r($this->db->last_query());// exit;
		//echo '<br/>';
			if (!$data) {
		...
		//		echo "2"; print_r($this->db->last_query());// exit;
		//echo '<br/>';
				if (!$data) {
		...
		//			echo "3"; print_r($this->db->last_query());// exit;
	//	echo '<br/>';
				}
			}
		}
